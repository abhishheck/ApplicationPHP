...
<body>
    ...
    <div align="center">
        ...
        <table border='1' cellpadding="2" cellspacing="1" bgcolor="" align="center">
            <tr>
                <td colspan="8" align="left"><a href="productImg_insert.php">Add New Product Image</a> </td>
            </tr>
            <tr>
                <th>Image Id</th>
                <th>Product Name</th>
            ...
            if (mysqli_num_rows($result) == 0) { ?>
                <tr>
                    <td colspan="5"> Rows not available.</td>
                </tr>
                <?php
            } else {
                $imgid = 1;
                ...
                ?>
                    <tr>
                        ...
                        <td><?php $pid = $row['pid'];
                            ...
                            ?></td>
                        <td><img src="<?php echo "../image/" . $row['img']; ?>" width="100" height="100" /></td>
